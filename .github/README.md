...
<p align="left">
  ...
  - 🔭 Currently working on personal projects related to <strong>offensive security, automation, and reverse shells</strong>.<br>
  - 📚 I'm learning about <strong>ethical hacking, Wi-Fi auditing, malware evasion, and Linux scripting</strong>.<br>
  - ⚡ In my free time, I explore <strong>CTFs, custom payload creation, and network protocol analysis</strong>.
</p>
...
<div align="center">
  <img src="https://streak-stats.demolab.com?user=nexuz0x&locale=en&mode=daily&theme=dark&hide_border=false&border_radius=5&order=3" height="220" alt="streak graph" />
</div>
